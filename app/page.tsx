  ...
  return (
    <div className="shadow p-5 border border-gray-100 mb-auto mx-auto max-w-7xl w-3/4 flex flex-col space-y-10 bg-white dark:bg-zinc-700 transition-all duration-700">
      ...
      <div className="w-full">
        ...
        <select
          id="countries"
          className="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-5 dark:bg-zinc-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        >
